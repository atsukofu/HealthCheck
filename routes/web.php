...
Route::get('/condition/month', 'App\Http\Controllers\ConditionController@month')->name('condition.month')->middleware('auth');
Route::post('/condition/month', 'App\Http\Controllers\ConditionController@search')->name('condition.search')->middleware('auth');
